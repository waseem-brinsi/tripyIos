...
class ApiService {
    ...
    func editProfile(userId: String ) {
        ...
        let url = URL(string: "http://172.18.21.85:3000/api/users/"+userId)!
        print(url)
    ...
    func forgotPassword (email: String) {
        // Set the URL for the POST request
        let url = URL(string: "http://172.18.21.85:3000/api/forgot")!
        print(url)
    ...
    func verifyResetCode(resetCode: String, token: String) {
        // Set the URL for the POST request
        let url = URL(string: "http://172.18.21.85:3000/api/verify")!
        print(url)
    ...
    func resetPassword(email: String, password :String) {
        // Set the URL for the POST request
        let url = URL(string: "http://172.18.21.85:3000/api/reset")!
        print(url)
