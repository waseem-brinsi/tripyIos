  ...
  //      cell.recetteLikeButton.setTitle("\(total)",for: .normal)
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        let taskFood = sessionFood.dataTask(with: urlRecette) { (data, response, error) in
            ...
            do {
                ...
                let allRecettes = try decoder.decode([Hotel].self, from: data)
    ...
    @objc func handleLongPressGesture(_ sender: UILongPressGestureRecognizer) {
        ...
        let deleteAction = UIAlertAction(title: "Delete", style: .destructive) { [weak self] _ in
            ...
            /*
            guard let url = URL(string: "http://172.18.21.85:3000/api/recettes/\(recetteId)") else { return }
            ...
            let url = "http://172.18.21.85:3000/api/recettes/\(recetteId)"
